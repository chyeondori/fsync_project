...
<div class="container-fluid px-5">
    ...
    <jsp:include page="../header.jsp">
        <jsp:param name="title" value="동기화 경로 등록"/>
    </jsp:include>
    <!-- Content Row-->
    <!-- 프레임 -->
    <form id="frm" method="post">
        <div class="px-5 py-3 my-5" style="border: 2px solid #dee2e6;">
            <div class="row my-5">
                ...
                <div class="col-8">
                    <input name="srcpath" id="srcpath" class="col-12 fs-5 px-3 py-3 rounded-3"
                           placeholder="동기화 원본으로 등록할 경로를 입력"/>
                </div>
            </div>
            <div class="row my-5">
                <div class="col-4 fs-5 py-3 fw-bold">
                ...
                <div class="col-8">
                    <input name="despath" id="despath" class="col-12 fs-5 px-3 py-3 rounded-3"
                           placeholder="동기화 대상으로 등록할 경로를 입력"/>
                </div>
            </div>
            <div class="row my-5">
                <div class="col-4 fs-5 py-3 fw-bold">
                ...
                <div class="col-8">
                    <input name="logpath" id="logpath" class="col-12 fs-5 px-3 py-3 rounded-3"
                           placeholder="로그 파일을 저장할 경로를 입력"/>
                </div>
            </div>
            <!-- 구분선 -->
            ...
            <div class="row my-5">
                ...
                <div class="col-8">
                    <input name="remark" class="col-12 fs-5 px-3 py-3 rounded-3" placeholder="등록할 경로의 설명 입력(선택)"/>
                </div>
            </div>
            <!-- 버튼 -->
