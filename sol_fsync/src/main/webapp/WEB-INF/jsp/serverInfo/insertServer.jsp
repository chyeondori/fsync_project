...
<div class="container-fluid px-5">
    ...
    <jsp:include page="../header.jsp">
        <jsp:param name="title" value="새로운 서버 등록"/>
    </jsp:include>
    <!-- Content Row-->
    <!-- 프레임 -->
    <form id="sForm" method="post">
        <div class="px-5 py-3 my-5" style="border: 2px solid #dee2e6;">
            <%--<div class="row my-5">
                ...
                <div class="col-8">
                    <select name="serverTy" id="serverTy" class="col-12 fs-5 px-3 py-3 rounded-3"
                        ...
                        <option value="A" selected>Agent</option>
            ...
            <div class="row my-5">
                ...
                <div class="col-8">
                    <input name="serverNm" id="serverNm" class="col-12 fs-5 px-3 py-3 rounded-3"
                           placeholder="에이전트 명을 입력"/>
                </div>
            </div>
            <div class="row my-5">
                <div class="col-4 fs-5 py-3 fw-bold">
                ...
                <div class="col-8">
                    <input name="serverIp" id="serverIp" class="col-12 fs-5 px-3 py-3 rounded-3"
                           placeholder="서버의 IP를 입력"/>
                </div>
            </div>
            <div class="row my-5">
                <div class="col-4 fs-5 py-3 fw-bold">
                ...
                <div class="col-8">
                    <input name="hostNm" id="hostNm" class="col-12 fs-5 px-3 py-3 rounded-3"
                           placeholder="서버의 호스트 명을 입력"/>
                </div>
            </div>
            <div class="row my-5">
                <div class="col-4 fs-5 py-3 fw-bold">
                ...
                <div class="col-8">
                    <input name="maxJobCnt" id="maxJobCnt" class="col-12 fs-5 px-3 py-3 rounded-3"
                           placeholder="서버가 최대로 작업할 수 있는 수량을 입력"/>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function checkValid() {
        ...
        if (serverIp === "") {
            ...
            console.log("서버 IP 유효성 테스트" + regServerIp.test(serverIp));
            }
